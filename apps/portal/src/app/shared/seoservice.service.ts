...
export const BrandTitle = '🛍TRIBES ® - для Ярких и Смелых'
...
export class SEOService {
  ...
  buildProductSeoAndSchema(product: ProductQuery['product']) {
      ...
      this.setMeta({
        ...
        "keywords": title?.split(' ') + "для ярких и смелых одежда tribes трайбс, модная одежда, бренд tribes трайбс, на каждый день, одежда на каждый день, водолазки, толстовки, то что модно, качественная одежда, одежда из натуральных тканей, натуральные материалы, качественная одежда, российский бренд, городской стиль, качественные материалы",
        "og:image": coverImage,
